  ...
  return (
    <div className="pt-[80px] bg-white">
              ...
              <div className="space-y-2.5 mb-8">
                {[
                  ...
                  <div key={cred} className="flex items-center gap-3 group">
                    <div className="w-5 h-5 rounded-full bg-[#EEE7FA] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                      <svg width="10" height="10" fill="none" viewBox="0 0 24 24" stroke="#9B70C7" strokeWidth="3" aria-hidden="true">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                      </svg>
                    </div>
                    <span className="font-sans text-sm text-[#25222A] font-medium group-hover:text-[#9B70C7] transition-colors">{cred}</span>
                  </div>
                ))}
              </div>

              {/* Stats */}
              <div className="flex gap-8 mb-8 p-6 bg-[#FCF8FB] rounded-2xl border border-[#EDE7EE] shadow-xs hover:shadow-md transition-shadow">
      ...
      <section className="py-24 bg-[#FCF8FB]">
        <Container>
          <AnimatedSection direction="up" delay={50} className="max-w-3xl mx-auto text-center">
      ...
      >
        <div
          className="absolute right-0 top-0 w-64 h-64 rounded-full opacity-50 pointer-events-none animate-float-slow"
        ...
        <Container className="relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            ...
            <FadeInStagger staggerDelay={120} direction="up" className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={item.title} className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-[#EDE7EE] card-elevate">
