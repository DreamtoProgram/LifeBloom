...
export function FounderSection() {
  return (
    ...
    >
      ...
      <div
        className="absolute top-1/2 left-0 w-96 h-96 rounded-full opacity-40 pointer-events-none -translate-y-1/2 -translate-x-1/3"
        style={{ background: 'radial-gradient(circle, #FBE8F0 0%, transparent 70%)' }}
        aria-hidden="true"
      />
      <div
        className="absolute top-1/2 right-0 w-72 h-72 rounded-full opacity-30 pointer-events-none -translate-y-1/2 translate-x-1/3"
      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-3xl overflow-hidden aspect-[4/5] shadow-xl shadow-[rgba(74,52,80,0.10)] border border-[#EDE7EE]">
              <Image
                src="/founder.jpg"
              ...
              <div
                className="absolute inset-0 bg-gradient-to-t from-[#FBE8F0]/25 via-transparent to-transparent"
                aria-hidden="true"
              />
            </div>

            {/* Credential badge (bottom right of image) */}
            <div className="absolute -bottom-6 -right-4 sm:-right-6 bg-white text-[#25222A] rounded-2xl p-5 shadow-xl z-10 max-w-[200px] border border-[#EDE7EE]">
            ...
            <div
              className="absolute -top-6 -left-6 w-40 h-40 rounded-full border border-[#C9A5E8]/30 pointer-events-none"
              aria-hidden="true"
            />
          </div>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="flex flex-wrap gap-2.5 mb-10">
              {[
                ...
                <span
                  key={chip}
                  className="font-sans text-xs font-medium px-3.5 py-1.5 rounded-full bg-[#EEE7FA] text-[#7F55A8] border border-[#C9A5E8]/40"
                >
                  {chip}
                </span>
              ))}
            ...
            {/* Credibility Stats */}
            <div className="grid grid-cols-2 gap-6 p-6 bg-white rounded-2xl border border-[#EDE7EE] mb-8">
