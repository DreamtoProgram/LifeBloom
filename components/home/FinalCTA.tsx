...
// ============================================================
// FinalCTA — Closing call-to-action section with animations
...
export function FinalCTA() {
  return (
    ...
    >
      {/* Decorative botanical blobs with organic floating */}
      <div
        className="absolute top-0 right-0 w-80 h-80 rounded-full opacity-50 pointer-events-none animate-float-slow"
        style={{ background: 'radial-gradient(circle, #FFFFFF 0%, transparent 70%)', transform: 'translate(40%, -40%)' }}
        aria-hidden="true"
      />
      <div
        className="absolute bottom-0 left-0 w-64 h-64 rounded-full opacity-40 pointer-events-none animate-float-reverse"
        style={{ background: 'radial-gradient(circle, #FFFFFF 0%, transparent 70%)', transform: 'translate(-40%, 40%)' }}
        aria-hidden="true"
      />
      ...
      {/* Subtle botanical petal — top right with organic float */}
      <div
        className="absolute top-8 right-12 w-20 h-32 opacity-25 pointer-events-none animate-float-slow"
        style={{
        ...
        aria-hidden="true"
      />
      {/* Subtle botanical petal — bottom left with reverse float */}
      <div
        className="absolute bottom-8 left-12 w-16 h-28 opacity-20 pointer-events-none animate-float-reverse"
        style={{
