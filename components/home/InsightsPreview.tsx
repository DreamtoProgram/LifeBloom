        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {featured && (
            <article className="lg:col-span-2 group">
              <Link href={`/insights/${featured.slug}`} className="block">
                <div
                  className="rounded-3xl overflow-hidden relative aspect-[16/9] md:aspect-[2/1] mb-5"
          ...
          <div className="flex flex-col gap-6">
            {others.map((insight) => (
              <article
                key={insight.slug}
                className="group flex-1 bg-white rounded-2xl p-6 border border-[#EDE7EE] hover:border-[#C9A5E8]/50 hover:shadow-md hover:shadow-[rgba(74,52,80,0.06)] transition-all duration-300"
              >
